...
//  console.log('cate=>>>' , categories)
  ...
  console.log('cofee ne========>', scrollToIndex)
                            ...
                            <View style ={styles.productContainer}>
                              <View style ={styles.product}>
                                <View style={{flexDirection: 'row'}}>
                                    <View>
                                      <Image style={styles.imageProduct} source={{ uri: pro.image[0].thumbnail}}
                                      resizeMode={"cover"}/>
                                    </View>
                                    <View style ={styles.textProductContainer}>
                                      <Text numberOfLines={2} style={styles.textName}>{pro.name}</Text>
                                      <Text style={styles.textPrice}>{formatCash(pro.price.toString())}đ</Text>
                                    </View>
