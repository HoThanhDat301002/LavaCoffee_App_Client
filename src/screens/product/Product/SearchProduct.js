    ...
    const renderItem = (item) => {
        return(
            <View style ={styles.flalistContainer}>
                <Pressable onPress={() => navigation.navigate('ProductDetail', {id: item.item._id})} >
                    <View style ={styles.productContainer}>
                        <View style ={styles.product}>
                          <View style={{flexDirection: 'row'}}>
                              <View>
                                  <Image style={styles.imageProduct} source={{ uri: item.item.image[0].thumbnail}}
                                  resizeMode={"cover"}/>
                              </View>
                              <View style ={styles.textProductContainer}>
                                  <Text numberOfLines={2} style={styles.textName}>{item.item.name}</Text>
                                  <Text style={styles.textPrice}>{formatCash(item.item.price.toString())}đ</Text>
                              </View>
                          </View>
                          <View></View>
                        </View>
