...
import { StyleSheet, Text, View, Image, TextInput, Pressable, ScrollView, ToastAndroid, TouchableOpacity, Dimensions, Alert } from "react-native";
        ...
        if (
          ...
          return;
            ...
            const res = await register(email, password, confirm_password);
                ...
                setEmail('');
                setPassword('');
                Alert.alert('Đăng kí', 'Tài khoản của bạn đăng kí thành công', [
                  {text: 'Ẩn',}
                ])
        }
      };
